...
namespace EncapsulationLecture.Classes
{
    public class Dog
    {
        ...
        {
            //THIS(this) - usually optional but allows you to specify you are working in.
            this.Name = name;
            Breed = breed;
        ...
        public void Speak(int numberOfBarks)
        {
            Console.WriteLine($"{this.Name} barks {numberOfBarks} times.");
        }
