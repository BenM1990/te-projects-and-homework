    ...
    public class LoopsAndArrayExercisesTests
    {
        ...
        public void MiddleWay()
        {
            ...
            */
            ...
            //Assert - we make sure sure that our expectations and reality line up
            int[] expectedResult = { 2, 5 };
            CollectionAssert.AreEqual(expectedResult, actualResult);

            //Let's do one more in this test method

            //Arrange
            //Keep using the LoopsAndArraysExercises from earlier
            ...
            CollectionAssert.AreEqual(secondExpectedResult, secondActualResult);
            //CollectionAssert.AreNotEqual(secondExpectedResult, secondActualResult);// will fail
