...
{
    [Route("hotels")] //route attribute defines the location of the controller ("localhost:44322/hotels")
    // [Route ([controller])]// would result in the same thing here since this is HotelsConroller
    ...
    public class HotelsController : ControllerBase //inherit from ControllerBase
    {
        ...
        public ActionResult<Hotel> GetHotel(int id) //ActionResult is the same as a controller method
        {
