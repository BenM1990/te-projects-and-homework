<template>
    <div class="main">
        ...
        <p>A dumb book by {{benMeasor}}</p>
            ...
            <div class="review" v-bind:class="{ favorite:review.favorite }"
...
export default {
    ...
    computed: {
        averageRating() {
            //add all the ratings and divide by number of ratings
            ...
            //need the 'this' keyword to access reviews outside the data function
        },
