...
function lastDigit(x, y){
	const digit1 = x.toString().slice(-1);
	const digit2 = y.toString().slice(-1);
...
*/
function oddOnly(numbers, divider){
	var multiples = []
	for (var i = 0; i < numbers.length; i++)
	{
		if(numbers[i] % divider === 1)
			{
...
*/
function filterEvens(numbers, divider){
	var multiples = []
	for (var i = 0; i < numbers.length; i++)
	{
