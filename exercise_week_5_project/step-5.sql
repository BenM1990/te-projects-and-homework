...
--VALUES (623, 4),(624, 4),(625, 4);

--SELECT * FROM site WHERE site_number IN (623, 624, 625);
...
--VALUES (52, 'Wayne Family', '2022-10-24', '2022-11-03'), (53, 'Parker Family', '2022-10-25', '2022-11-03'), (54, 'Kent Family', '2022-10-26', '2022-11-03');
 ...
 */
 --UPDATE reservation SET from_date = '2022-10-14' WHERE name = 'Wayne Family';
 --UPDATE reservation SET to_date = '2022-10-21' WHERE name = 'Wayne Family';
