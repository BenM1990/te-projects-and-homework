...
--SELECT COUNT(*) FROM site WHERE utilities = 1;
...
--SELECT reservation_id, site_id, name, from_date, to_date FROM reservation WHERE create_date > '2022-10-01' AND create_date < '2022-10-31'
...
--SELECT from_date, COUNT(reservation_id) AS number_of_reservations FROM reservation GROUP BY from_date ORDER BY from_date
